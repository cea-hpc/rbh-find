...
/**
 * timedelta2filter - build a filter from a string representing a time as an
 * integer. If given integer without '+' or '-', will filter on
 * ]now - (delta + 1) * unit; now - delta * unit[.
 *
