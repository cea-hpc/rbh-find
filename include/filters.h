...
/**
 * Test if a sort already exist
 *
 * @param sorts     a pointer to a list of sort attribute
 * @param count     the size of \p sorts
 * @param field     a new sorts attribute
 *
 * @return          1 if exists,
 *                  0 then
 */
 ...
 * @param count         a pointer to the size of \p sorts
 * @param field         a sorts attribute
 *
